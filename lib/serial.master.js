...
MbSimpleSerialMaster.prototype.read_item = function (itemname){
    ...
    var item_info = split_itemname(itemname);
...
//Utility function to split itemname into blockname and indexer
function split_itemname(itemname) {
    
    var match;
    
    //Using g so we get index for next search, otherwwise regex.lastIndex
    //would always be 0.
    var regex = /^(.*)@/g;
